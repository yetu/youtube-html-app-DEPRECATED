...
gulp.task('build-yt-viewer-level2-tv', ['build-scripts', 'copy-assets', 'copy-ref-templates', 'build-style']);
gulp.task('watch-yt-viewer-level2-tv', ['build-scripts', 'copy-assets', 'copy-ref-templates', 'build-style', 'dev-watch']);