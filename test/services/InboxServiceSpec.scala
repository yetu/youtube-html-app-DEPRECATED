...
import models.services.InboxService
 ...
 */
//TODO: extract BaseSpec class
class InboxServiceSpec extends PlaySpec with ScalaFutures with AsyncAssertions with OneAppPerSuite{
  //OneAppPerSuite: starts whole playserver
